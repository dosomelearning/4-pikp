-- Star schema for Source 1: US-Accidents (naloga2b dual-fact design)
-- PostgreSQL DDL (warehouse-style schema)
-- Modeling strategy:
--   - Keep legacy fact table unchanged: dw.fact_accident (v1)
--   - Add new snowflake-aware fact table: dw.fact_accident_v2
--   - Reuse shared dimensions, add new location snowflake dimensions
...
-- Legacy location dimension (shared, kept intact)
...
-- New conformed county dimension for v2 path.
...
-- New detailed location dimension normalized under county.
