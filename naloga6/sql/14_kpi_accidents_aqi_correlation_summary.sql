-- Dashboard 4: Overall accident/AQI correlation summary.
-- Grain: one summary row across state/month observations.
-- Intended Superset charts: Big Number correlation cards.
...
SELECT
    ...
    ROUND(CORR(accident_count::numeric, avg_aqi)::numeric, 4) AS corr_accident_count_avg_aqi,
    ROUND(CORR(avg_duration_minutes::numeric, avg_aqi)::numeric, 4) AS corr_avg_duration_avg_aqi,
