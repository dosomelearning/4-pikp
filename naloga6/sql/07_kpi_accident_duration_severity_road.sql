-- KPI 2: Accident handling duration base rows for severity and road-signal charts.
-- Grain: one row per accident.
-- Intended Superset chart: grouped bar chart by severity and primary road signal.
